				...
				<div class={styles.view}>
					...
					<ul class={styles.timeline}>
						...
						<li>
							...
							<a class={styles.location} target="_blank" href="http://crafton.eu">@Crafton <span>(http://crafton.eu)</span></a>
						</li>
						<li>
					...
					<ul class={styles.skills}>
						<h3>web stack</h3>
						<li class={styles.expert}>SASS (with BEM)</li>
						<li class={styles.advanced}>React/Preact with Redux</li>
						<li class={styles.intermediate}>(with Saga, rx.js too)</li>
						<li class={styles.intermediate}>Typescript</li>
