    ...
    <div class={style.view}>
      ...
      <ul class={style.timeline}>
        ...
        <li>
          ...
          <h3 class={style.title}>I worked as a freelancea designer and fullstack developer.</h3>
        ...
        <li>
          ...
          <h3 class={style.title}>I am working as a freelancea designer and fullstack developer.</h3>
